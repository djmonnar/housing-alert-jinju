...
카카오 기본 템플릿의 링크 버튼은 Product Link 웹 도메인 등록 조건을 탑니다. 공고가 있을 때는 첫 공고의 원문 링크를 버튼으로 사용합니다. 원문 버튼을 바로 열려면 LH, 마이홈, 진주시청, 진주시 청년온라인플랫폼 도메인을 앱 설정에 등록하세요. `KAKAO_WEB_LINK_URL`은 오늘의 주거 팁만 발송될 때 사용할 참고 링크입니다.
